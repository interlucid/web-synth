import { svg, html, render } from '../scripts/lit-html/lit-html.js';
...
render(html`
            ...
            <h1>Web Synth!</h1>
            <svg xmlns="http://www.w3.org/2000/svg" width="${ keyboardLength * 55 }" height="300" viewBox="0 0 ${ keyboardLength * 90 } 500" stroke-linejoin="round">
        ...
        `, document.querySelector('#lit'));

const myRender = () => {
    // let keylen = keyboardLength;
    // render(keyboard, document.querySelector('#lit'));
}
